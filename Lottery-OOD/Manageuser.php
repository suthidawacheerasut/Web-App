...
<!-- top-brands -->
 ...
 <tr align = 'center'> <td class="info">ชื่อผู้ใช้งาน</td><td class="info">รหัสผ่าน</td><td class="info">ชื่อ</td>
 <td class="info">นามสกุล</td><td class="info">เบอร์โทร</td><td class="info">ที่อยู่</td><td class="info">ลบสมาชิก</td></tr>
...
echo "<tr align = 'center'> <td class='Warning'>".$read["id_member"]."</td><td class='Warning'>".$read["password"]."</td><td class='Warning'>".$read["fName"]."</td>
 <td class='Warning'>".$read["lName"]."</td><td class='Warning'>".$read["phone"]."</td><td class='Warning'>".$read["address"]."</td>
 <td class='Warning'>
 <a href='confirmdeletemember.php?user=".$read['id_member']."'>ลบ</a></td></tr> "; } ?>
 </table>
