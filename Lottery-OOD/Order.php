...
$order = new ordering;
$data = $order->confirmPayment();


if(isset($_GET['id'])){

	$no =  $_GET['id'];
	$re =  $order->setStatus('ชำระเงินแล้ว',$no);
	

     // header("location:Order.php?id=$no&m='ยืนยัน'"); 
 ...
 if($re == 1)  
      {  
        ...
        $message = 'ยืนยัน'; 
     header("location:order.php?&m='ยืน'");  
  ...
  if(isset($_GET['m']))  
        ...
        echo '<script>alert("ยืนยันการชำระเงิน")</script>'; 
...
<!-- top-brands -->
	...
	<div class="top-brands">
		<div class="container">
			...
			echo '<center><table  width = "700" height = "120"  bordercolor = "black"></center> 

			<tr bgcolor= "#FFCCFF"><td >&nbsp;&nbsp;&nbsp;&nbsp;<b>เลขที่ใบสั่งซื้อ :</b> '.$read['orderno'].'<br>

			&nbsp;&nbsp;&nbsp;<b>วันเวลาซื้อขาย :</b> '.$read['saledate'].' '.$read['saletime'].'<br>&nbsp;&nbsp;&nbsp; <b>ราคาทั้งหมด :</b> '.$read['totalprice'].' บาท <br>&nbsp;&nbsp;&nbsp; <b>สถานะ : </b>'.$read['status_'].'</td> &nbsp;&nbsp;&nbsp;&nbsp;
			<td width="300" align = "center"><br><br><br> <a href = "Order.php?id='.$read["orderno"].'"><input  class="btn btn-primary" type = "submit" name = "confirm" value = "ยืนยันการชำระเงิน">  <a href = "Printreceipt.php?id='.$read["orderno"].'" target = "_blank"><input  class="btn btn-danger" type = "button" value = "พิมพ์ใบเสร็จ"></td>
