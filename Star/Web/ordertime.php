    ...
    <div><img src="Pic/bg1.png" width="100%" height="350px"></div>
        ...
        <div class="flexsearch">
            <div class="flexsearch--wrapper">
                <form class="flexsearch--form" action="ordertime.php" method="post">
...
$sql = "SELECT Distinct*
        FROM STAR LEFT OUTER JOIN PICTURE
          ON PICTURE.P_id_star= STAR.Id_star
          WHERE First_name_star LIKE '%$search%' OR Last_name_star LIKE '%$search%' OR (First_name_star LIKE '%$search%' AND Last_name_star LIKE '%$search%')
         group By Id_star ASC
