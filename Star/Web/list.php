...
<div id="wrap">
    ...
    <div class="flexsearch">
        <div class="flexsearch--wrapper">
            <form class="flexsearch--form" action="list.php" method="post">
...
function show(){
 ...
 $id_customers = $_SESSION['Id_customers'];
                ...
                $sql = "SELECT First_name_star,Last_name_star,Id_reserve,Time_work,Date_work,Detail_work,Total_time_work,The_propose_price,P_picture FROM star LEFT OUTER JOIN picture ON Id_star = P_id_star JOIN reserve ON R_id_customer = '$id_customers' and R_id_star = Id_star and State_reserve = 0 group By Id_reserve ASC";
            ...
            ?>
                        <div class="icons"><a href="edit_job.php?id_reserve=<?php echo $row['Id_reserve']; ?>">แก้ไขรายละเอียด</a>
                              </div>
                        </figcaption>
                ...
                <?php  
                    ...
                    echo "<center><h1>ไม่มีรายการจองคิว</h1></center>";
                }
                ?>
            </div>
    </div>
...
function confirmList2(id) {
    if(confirm("คุณต้องการยืนยันการจองคิวใช่ไหม")) {
        window.location.href='update_list.php?id_reserve='+id;
        return true;
    }
}
</script>
...
function search_name($search){
               $id_customers = $_SESSION['Id_customers'];
                ...
                $sql = "SELECT First_name_star,Last_name_star,Id_reserve,Time_work,Date_work,Detail_work,Total_time_work,The_propose_price,P_picture
                    FROM star,reserve,picture
                    where First_name_star LIKE '%$search%' OR Last_name_star LIKE '%$search%'
