...
session_start();
    if(isset($_POST['bttLogin'])){
        ...
        $query = "SELECT * FROM STAR_MANAGER WHERE Id_star_manager='$Id_star_manager' AND Password_star_manager = '$Password_star_manager'";
        $result = mysqli_query($connect,$query);

        if (mysqli_num_rows($result) == 1){
            $_SESSION['Id_star_manager'] = $Id_star_manager;
            header('Location:home_manager.php');
        }else{
            echo "<script>alert('ชื่อผู้ใช้งานหรือรหัสผ่านไม่ถูกต้อง');location.href='login_manager.php';</script>";
        }
    }
...
<body>
  ...
  <form method="POST">
    <div class="login-html">
        ...
        <center><label for="tab-1" class="tab">ลงชื่อเข้าสู่ระบบผู้จัดการ</label></center>
                ...
                <div id="example" role="application">
                    <div id="tshirt-view" class="demo-section k-content">
                        ...
                        <div class="group">
                            ...
                            <!-- validate -->
                            <input id="user" name="Id_star_manager" type="text" class="input" pattern=".{3,}" required title="ชื่อผู้ใช้งาน" placeholder="ชื่อผู้ใช้งาน"
                        ...
                        <div class="group">
                            ...
                            <input id="pass" name="Password_star_manager" type="password" class="input" data-type="password"  pattern=".{8,}" required title="รหัสผ่าน" placeholder="รหัสผ่าน"
